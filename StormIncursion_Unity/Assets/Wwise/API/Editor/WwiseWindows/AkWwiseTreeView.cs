...
public class AkWwiseTreeView : WwiseTreeView
{
	...
	protected override bool CanRename(WwiseTreeViewItem item)
	{
		return CanRenameWithLog(item, true);
	}

	protected bool CanRenameWithLog(WwiseTreeViewItem item, bool log)
	{
	...
	protected bool CanDelete(WwiseTreeViewItem item, bool log = true)
	{
		if (!CheckWaapi()) return false;
